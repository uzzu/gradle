...
====
include::sample[dir="userguide/tutorial/properties/groovy",files="gradle.properties[]"]
====

====
include::sample[dir="userguide/tutorial/properties/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/properties/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/buildEnvironment/javaCompileOptions/groovy",files="build.gradle[]"]
include::sample[dir="userguide/buildEnvironment/javaCompileOptions/kotlin",files="build.gradle.kts[]"]
====
...
====
include::sample[dir="userguide/tutorial/configureTaskUsingProjectProperty/groovy",files="build.gradle[]"]
include::sample[dir="userguide/tutorial/configureTaskUsingProjectProperty/kotlin",files="build.gradle.kts[]"]
====
